                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseSix" class="accordion-collapse collapse" data-bs-parent="#helpAccordion">
                            <div class="accordion-body">
                                ...
                                <ol>
                                    <li>Выделите ТМЦ (выдан на объект или в работе)</li>
                                    <li>Нажмите «Отправить в сервис» в боковом меню</li>
                                    <li>Укажите причину ремонта (сверьте номер, модель, наименование, юр. лицо)</li>
                                    <li>Нажмите «Отправить» — статус сразу «В ремонте», счёт администратору не блокирует работу</li>
                                </ol>

                                <h6>Возврат из сервиса:</h6>
                                <ol>
                                    <li>Выделите ТМЦ со статусом «В ремонте»</li>
                                    <li>Нажмите «Вернуть из сервиса» в боковом меню</li>
                                    <li>Укажите комментарий (по желанию) и нажмите «Вернуть»</li>
                                    <li>Можно вернуть до или после приложения счёта администратором</li>
                                </ol>

                                <h6>Архив ремонтов (администратор):</h6>
                                <ol>
                                    <li>Уведомление «Ремонты без счёта» — ремонты без приложенного счёта</li>
                                    <li>Откройте архив и сохраните счёт, УПД и сумму когда документы поступят</li>
                                    <li>Полный реестр — раздел «Списание/затраты на ремонт»</li>
                                </ol>
                        ...
                        <div id="collapseSeven" class="accordion-collapse collapse" data-bs-parent="#helpAccordion">
                            <div class="accordion-body">
                                ...
                                <ul>
                                    ...
                                    <li>Ремонты без счёта — в архиве можно приложить счёт позже</li>
